...
const Login = () => {
  return <div>
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
        ...
        Login
        <span className='text-blue-300'> AlphaChat</span>
        </h1>
        ...
        <form>
           <div>
                ...
                <input type='username' placeholder='Enter Username' className='w-full input input-bordered h-10'/>
           </div>
...
//           <h1 className='text-3xl font-semibold text-center text-gray-100'>
//           Login
//           <span className='text-blue-300'> Alpha Chat</span>
//           </h1>
